...
public class AndroidPermissionsPage extends BasePage implements PerimissionsPage {
    public AndroidPermissionsPage(WebDriver webDriver) {
        super(webDriver);
    }

    //Locators
    public enum AndroidLocationPermissionsPagePageLocators {
...
//        DONT_ALLOW_BTN("xpath=//android.widget.Button[@resource-id='com.android.permissioncontroller:id/permission_deny_button']"),
        ...
        AndroidLocationPermissionsPagePageLocators(String locator) {
            myLocator=locator;
        }
    ...
    public void clickAllowPermissionsBtn() {
        ...
        DriverActions.clickElement(webDriver, AndroidLocationPermissionsPagePageLocators.PERMISSIONS_ALLOW_BTN.getLocator(), 10L);
    }

    @Step("allowPermissionsIfVisible")
    public void allowPermissionsIfVisible(){
        Log.info("allowPermissionsIfVisible");
        if (DriverCheck.isElementByVisible(webDriver,AndroidLocationPermissionsPagePageLocators.PERMISSIONS_DIALOG.getLocator(),10L)){
