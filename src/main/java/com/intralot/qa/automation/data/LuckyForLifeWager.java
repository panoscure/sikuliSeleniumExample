...
public class LuckyForLifeWager {

    public LuckyForLifeWager() {
    }
    ...
    public Double getMegaplierCost(){
        if (this.megaplier){
            return Double.valueOf(CustomProperties.getPropertyValue("luckyForLifeBasePrice")) * this.getNoOfBoards();
        }
        else
            return 0.00;
    }
